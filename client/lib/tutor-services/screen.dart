...
class _TutorServicesScreenState extends State<TutorServicesScreen> {
  ...
  Future<List<Map<String, dynamic>>> _fetchTutorServices() async {
    ...
    final response = await http.get(Uri.parse(
        'http://201.23.18.202:3333/tutors/${credentials['user_id']}/services'));
  ...
  Future<Map<String, dynamic>> _fetchTutor() async {
    Map<String, String?> credentials = await getUserCredentials();
    final url =
        Uri.parse('http://201.23.18.202:3333/tutors/${credentials['user_id']}');
            ...
            return FutureBuilder<List<Map<String, dynamic>>>(
              ...
              builder: (context, servicesSnapshot) {
                if (servicesSnapshot.connectionState ==
                  ...
                  return const Center(
                      child: Text('Falha ao carregar os servicos'));
